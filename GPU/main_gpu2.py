...
import code_caitien_gpu_histogram_ver2 as codechuan  # Import file chứa các hàm cần sử dụng
import os

# Đường dẫn tương đối đến một tệp
relative_path = "GPU\image_data_100 copy"
...
def kiemThuChayNhieuLanMain(solan):
    ...
    # Đường dẫn tương đối đến một tệp
    relative_path = "image_data_100 copy"
