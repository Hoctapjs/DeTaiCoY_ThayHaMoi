...
# Nhân ma trận-vector với Numba (luôn song song hóa)
...
# Lanczos cho ma trận thưa (Numba, luôn song song hóa)
@jit(nopython=True)
...
# Tính trị riêng và vector riêng (luôn dùng song song hóa)
def compute_eigen(L, D, k=2):
    ...
    n = L.shape[0]
    # Luôn chuyển sang CSR và dùng song song hóa
